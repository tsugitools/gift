...
function change_question_type(question_num) {
  ...
  if (selected_value != "") {
    ...
    switch(selected_value) {
      ...
      case "multiple_choice_question": template_type="mc_authoring"; break; // Multiple choice and multiple answer are handled the same
      case "multiple_answers_question": template_type="mc_authoring"; break; // Multiple choice and multiple answer are handled the same
